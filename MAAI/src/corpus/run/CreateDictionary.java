...
public class CreateDictionary {
    ...
    public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException {
        ...
        int i=0;
        while (i<1){
            List<String> listOfWords = ProcessText.cleanText(pages.get(i).getText(),stopWords,term);
            System.out.println(Arrays.deepToString(listOfWords.toArray()));
            ProcessText.createHachTable(listOfWords);
            i++;
        }
